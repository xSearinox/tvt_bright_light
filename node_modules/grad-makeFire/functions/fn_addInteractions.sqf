...
//self
_action = ["GRAD_makeFire", "Make fire", GRAD_makeFire_moduleRoot + "\data\fire.paa", {[] call GRAD_makeFire_fnc_makeFire}, {playerSide == independent}] call ace_interact_menu_fnc_createAction;
