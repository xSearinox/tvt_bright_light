...
randomizationMode = 0;                                                          // einige Loadouts unterstützen zufällige Ausrüstungsvergabe. randomizationMode legt fest, wie mit diesen Loadouts umgegangen wird.
                                                                                // 0 - disabled, 1 - enabled, 2 - enabled for players only, 3 - enabled for AI only

customGear = 600;                                                               // Legt fest wann Spieler ihr Loadout anpassen dürfen.
